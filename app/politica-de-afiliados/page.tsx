  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="space-y-8 text-base leading-relaxed" style={{ color: '#2D2D2D' }}>
        <section>
          <h2 className="font-serif text-xl font-bold mb-2" style={{ color: '#1E3A5F' }}>O que são links de afiliados?</h2>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold mb-2" style={{ color: '#1E3A5F' }}>Como isso nos afeta?</h2>
          <p style={{ color: '#6B7280' }}>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold mb-2" style={{ color: '#1E3A5F' }}>Isso afeta nossas indicações?</h2>
          <p style={{ color: '#6B7280' }}>
        ...
        <section>
          <h2 className="font-serif text-xl font-bold mb-2" style={{ color: '#1E3A5F' }}>Programas de afiliados</h2>
          <p style={{ color: '#6B7280' }}>
        ...
        <div className="rounded-xl p-5 text-sm" style={{ backgroundColor: '#F5EFE6', border: '1px solid #E8E0D5', color: '#6B7280' }}>
